          ...
          <div class="registeremp ms-5 px-3 pt-4">
            <table class="table">
                <thead >
                    ...
                    <td class="text text-info ">NIC</td>
                    <td class="text text-info ">POINTS</td>
                    <td class="text text-info ">TOTAL JOBS DONE</td>
                </tr>
                </thead>
                <tbody>
                <tr></tr>    
                <tr class="col-sm-2">
                    <td scope="col text-center">1234</td>
                    <td class="w-25 text-center"><img src="employee.jpg" class="img-fluid img-thumbnail" alt="emp"></td>
                        <td scope="col text-center">985741125V</td>
                        <td scope="col text text-center">100</td>
                        <td scope="col text text-center">50</td>
                </tr>
                <tr class="col-sm-2">
                    <td scope="col"></td>
                    <td class="w-25"></td>
