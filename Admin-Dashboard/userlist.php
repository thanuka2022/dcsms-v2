          ...
          <div class="registeremp ms-5 px-3 pt-4">
            <table class="table">
                <thead class="col-sm-4">
                    ...
                    <td class="text text-info">ADDRESS</td>
                    <td class="text text-info">EMAIL</td>
                    <td class="text text-info">NIC</td>
                    <td class="text text-info">TOTAL ORDERS</td>
                </tr>
                </thead>
                <tbody>
                <tr></tr>    
                <tr class="col-sm-4" >
                    <td scope="col">12547</td>
                        <td scope="col">516/Panadura</td>
                        <td scope="col">tharin@gmail.com</td>
                        <td scope="col">44578547822V</td>
                        <td scope="col">50</td>
                </tr>
                <tr class="col-sm-4">
                    <td scope="col"></td>
            ...
            <table class="table">
                ...
                <tr></tr>    
                <tr class="col-sm-4">
                        <td scope="col">11458</td>
                        <td scope="col">517/Wadduwa</td>
                        <td scope="col">tharin@gmail.com</td>
                        <td scope="col">14785212325V</td>
                        <td scope="col">50</td>
                </tr>
                <tr class="col-sm-4">
                    <td scope="col"></td>
