<?php
  ...
  $sql="SELECT emp_fname,emp_photo,emp_qulification from employee";
   ...
   <div class="main-container d-flex">
    <div class="sidebar " id="side_nav">
        ...
        <ul class="list-unstyled px-2 ">
            <li class="active"><a href="registeremployee.php" class="text-decoration-none px-3 py-3 d-block">REGISTER EMPLOYEE</a></li>
           ...
           <table class="table table py-4"> 
                <thead class="text-center col-sm-4">
                  <tr>
                        ...
                        <td scope="col" class="text text-info">IMAGE</td>
              ...
              while($row=mysqli_fetch_assoc($result))
              {
                 ...
                 echo "<td><img src='images/{$row['emp_photo']}' width='100px' height='100px'> </td>";
                    
                  //  echo "<img src ="'C:\wamp64\bin\mysql\mysql5.7.36\data\dcsms'.$row['emp_photo']. 'width = 100px '    height = 100px"></td>";
                  //echo "<td> <img src="data:image/jpeg;base64,<?php echo base64_encode( $image_data ); " />
            ...
            <?php
                ...
                {
                  $sql1="INSERT INTO registered_employee(emp_name,emp_profile,emp_status)SELECT distinct emp_fname,emp_photo,emp_qulification from employee ";
