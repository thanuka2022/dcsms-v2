                      ...
                      <div class="col-md-4 mb-4">  
                        ...
                        <div class="col-md-4 mb-4">
                          <tr>
                            <td scope="col"></td>
                            <td scope="col"></td>
                            <td scope="col" class="text-success">Pending</td>
                          </tr>
                          </div>
                        </thead>
                      </div>
                        ...
                        <tbody class="text-center">
                          <div class="col-sm-4 mb-4">
                            <tr>
                                ...
                                <td class="fs-20">Name : Alan sadtah<br>2 Year experienced<br>Estimate price for hour Rs.950<br>Mobile  : 2477856522</td>
                                <td><button type="button" class="btn btn-success text-white btn btn-sm col-sm-9 ">Change</button></td>
                                <td><a href="../Customer-Dashboard/Payment/payment.php"><input type="submit" value="Accept" class="btn btn-primary btn-sm col-sm-9"></a></td>
                            </tr>
                          </div>
                        </tbody>
                    </table>
