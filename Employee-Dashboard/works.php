   ...
   <div class="main-container d-flex">
    <div class="sidebar hh" id="side_nav">
        ...
        <ul class="list-unstyled px-2 ">
            ...
            <li class="active"><a href="works.php" class="text-decoration-none px-3 py-3 d-block">YOUR WORKS</a></li>
    ...
    <div class="content">
        ...
        <nav class="navbar navbar-expand-md py-3 navbar-light bg-light">
          ...
          <div class="dashboard-content ms-5 px-3 pt-4">
            ...
            <table class="table table py-4 table-borderless">
                <thead  class="text-align-left">
                  <tr>
                    <th scope="col" text-sucess>Customer Details</th>
                    <th scope="col">ORDER ID #23567</th>
                ...
                <tbody class="text-align-left">
                    ...
                    <tr>
                        <td>
                          Address:No 680/New Avenue,Galle
                        </td>
                        <td>
                    ...
                    <tr>
                      ...
                      <td>
                        <button type="button" class="btn btn-primary text-white">Completed</button>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        Work type:Residential cleaning
                      </td>
                      <td>
