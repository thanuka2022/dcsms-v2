...
$sql1="SELECT job_order_id,job_order_category,job_order_date,job_order_postalcode from job_order ";
            ...
            <table class="table table py-4">
                ...
                <?php
                  while($row=mysqli_fetch_assoc($result))
                  {
                   echo " <tr>";
                   echo " <td>";
                   echo "  $row[job_order_id] </td>";    
                   echo "<td>$row[job_order_category]</td>";  
                   echo "<td>$row[job_order_date]</td>";
                   echo "<td>$row[job_order_postalcode]</td>";
                   echo  "<td> ";
                   echo "<a href= '#' class='btn btn-success text-white '>Accept</a> </td>";
    ...
    <table class="table table py-4">
        ...
        <tbody class="text-center">
            <tr>
              ...
              <td>2022-01-15</td>
              <td> <a href="#" class="btn btn-success text-white ">Accept</a>
              </td>
            </tr>
          </tbody>
      </table>
