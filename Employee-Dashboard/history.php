    ...
    <table class="table table py-4">
        ...
        <tbody class="text-center">
            ...
            <div class="row">
                ...
                <p class="text-center lead">Total Balance Rs 800</p>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <p class="text-center lead"> <button type="button" class="btn btn-primary text-white col-sm-1">Withdraw</button></p>
                </div>
            </div>
